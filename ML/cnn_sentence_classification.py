...
# data loading
data_path = '/Users/jaejin/dev/Classify-positive-and-negative/RRing/data.csv'
    ...
    with sess.as_default():
        ...
        def dev_step(x_batch, y_batch, writer=None):
          ...
          #  print(sess.run([cnn.loss, cnn.accuracy],feed_dict))
            ...
            if a == [1.0] :
                print('이 문장은 html 이네요 !')
                print('html')
            else:
                print('이 문장은 javascript 네요 ')
                print('javascript')
            #print(sess.run([cnn.accuracy], feed_dict))
            time_str = datetime.datetime.now().isoformat()
           # print("{}: loss {:g}, acc {:g}".format(time_str, loss, accuracy))

        modelName = "/Users/jaejin/dev/Classify-positive-and-negative/RRing/model-100"
